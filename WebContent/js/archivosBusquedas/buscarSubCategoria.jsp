...
<%
            ...
            salida += "<a href=\"ontologias/ontologias.jsp?id="+subcategoria.getId()+"\" style=\"color:inherit; hover:'text-decoration: none;'\">";
            salida += "<div class=\"card\" style=\"width: 11rem; height: 10rem; background-image: url('data:image/png;base64,"+subcategoria.getImagen()+"'); background-color: rgb(167, 161, 161,0.5);  background-size: cover; box-shadow: -4px 5px rgb(237,234,245,0.5); \">";
            salida += "<div class=\"card-body\">";
            salida += "<p style=\"text-align: center; padding-top: 32%; color:white\" class=\"card-text\">"+subcategoria.getTitulo()+"</p>";
            salida += "</div>";
            salida += "</div>";
            salida += "</a>";
            salida += "</div>";
