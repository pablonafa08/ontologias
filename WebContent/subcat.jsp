		...
		<div class="row" id="subcategorias">
			<%
				String id = request.getParameter("id").toString();
					...
					ArrayList<SubCategoria> subcategorias = conexion.listarXCategoria(id);
					for (SubCategoria subcategoria : subcategorias) {
						if (subcategoria.getImagen() != null) {
			%>
			<div style="margin-right: 8%; margin-bottom: 3%;" class="col-2 ">
				<a href="ontologias/ontologias.jsp?id=<%out.print(subcategoria.getId());%>" style="color: inherit; hover: 'text-decoration: none;'">
					<div class="card"
